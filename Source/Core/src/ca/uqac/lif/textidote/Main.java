...
public class Main 
{
	...
	public static int mainLoop(String[] args, InputStream in, PrintStream out, PrintStream err, Class<?> base_class) throws IOException
	{
		...
		for (String expandFile : processed_filenames) {
        	...
        	if(file.delete()){
            	System.err.println(expandFile + " deleted from Project root directory");
        	} else {
				System.err.println(expandFile+ " doesn't exist in the project root directory");
			}
		}
		if (num_files == 0)
		{
    ...
    public static void expandMainTexFile(String mainTexFilePath, String outTexFilePath) throws IOException {
        ...
        System.err.println("Finish expanding main tex file!");
    }
